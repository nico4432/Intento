...
int main() {
	...
	int* mov = &movimientos;
	 ...
	 if (largo != 2) {
		...
		while (condiciones(coorActualX, coorActualY, coordenadasFinalesX, coordenadasFinalesY, matriz) != 2) {
			posicion coorActual;
			if (movimientos == 1) {
				if (listaPosiciones[0].R == 1) {
					listaPosiciones[0].R = 0;

					matriz[listaPosiciones[0].posx + 1][listaPosiciones[0].posy - 1] = '#';
					matriz[listaPosiciones[0].posx][listaPosiciones[0].posy - 1] = '#';
					matriz[listaPosiciones[0].posx - 1][listaPosiciones[0].posy - 1] = '#';
					matriz[listaPosiciones[0].posx - 1][listaPosiciones[0].posy] = '#';
					matriz[listaPosiciones[0].posx - 1][listaPosiciones[0].posy + 1] = '#';

					coordenadasFinalesX = listaPosiciones[0].posx + 1;
					coordenadasFinalesY = listaPosiciones[0].posy;

					coorActual = nuevaPosicion(matriz, listaPosiciones[0].posx - 1, listaPosiciones[0].posy + 1);
					...
					coordenadasFinalesX = listaPosiciones[0].posx;
					coordenadasFinalesY = listaPosiciones[0].posy + 1;
				...
				if (listaPosiciones[movimientos - 1].R == 1) {
					...
					coorActual = nuevaPosicion(matriz, listaPosiciones[movimientos - 1].posx, listaPosiciones[movimientos - 1].posy + 1);
					listaPosiciones = agregarPosicion(listaPosiciones, mov, coorActual);
					matriz[listaPosiciones[movimientos - 1].posx][listaPosiciones[movimientos - 1].posy] = '#';

					coorActualX = listaPosiciones[movimientos - 1].posx;
					coorActualY = listaPosiciones[movimientos - 1].posy;
				}
				else if (listaPosiciones[movimientos - 1].U == 1) {
					listaPosiciones[movimientos - 1].U = 0;
					coorActual = nuevaPosicion(matriz, listaPosiciones[movimientos - 1].posx - 1, listaPosiciones[movimientos - 1].posy);
					listaPosiciones = agregarPosicion(listaPosiciones, mov, coorActual);
					matriz[listaPosiciones[movimientos - 1].posx][listaPosiciones[movimientos - 1].posy] = '#';
